...
public let hueRed: CSSAngle = `var`("--hue-red")
public let hueOrange: CSSAngle = `var`("--hue-orange")
public let hueYellow: CSSAngle = `var`("--hue-yellow")
public let hueGreen: CSSAngle = `var`("--hue-green")
public let hueMint: CSSAngle = `var`("--hue-mint")
public let hueTeal: CSSAngle = `var`("--hue-teal")
public let hueCyan: CSSAngle = `var`("--hue-cyan")
public let hueBlue: CSSAngle = `var`("--hue-blue")
public let hueIndigo: CSSAngle = `var`("--hue-indigo")
public let huePurple: CSSAngle = `var`("--hue-purple")
public let huePink: CSSAngle = `var`("--hue-pink")
public let hueBrown: CSSAngle = `var`("--hue-brown")
public let hueGray: CSSAngle = `var`("--hue-gray")
