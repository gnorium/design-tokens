...
public let lightnessRed: CSSValue = `var`("--lightness-red")
public let lightnessOrange: CSSValue = `var`("--lightness-orange")
public let lightnessYellow: CSSValue = `var`("--lightness-yellow")
public let lightnessGreen: CSSValue = `var`("--lightness-green")
public let lightnessMint: CSSValue = `var`("--lightness-mint")
public let lightnessTeal: CSSValue = `var`("--lightness-teal")
public let lightnessCyan: CSSValue = `var`("--lightness-cyan")
public let lightnessBlue: CSSValue = `var`("--lightness-blue")
public let lightnessIndigo: CSSValue = `var`("--lightness-indigo")
public let lightnessPurple: CSSValue = `var`("--lightness-purple")
public let lightnessPink: CSSValue = `var`("--lightness-pink")
public let lightnessBrown: CSSValue = `var`("--lightness-brown")
public let lightnessGray: CSSValue = `var`("--lightness-gray")

public let chromaRed: CSSValue = `var`("--chroma-red")
public let chromaOrange: CSSValue = `var`("--chroma-orange")
public let chromaYellow: CSSValue = `var`("--chroma-yellow")
public let chromaGreen: CSSValue = `var`("--chroma-green")
public let chromaMint: CSSValue = `var`("--chroma-mint")
public let chromaTeal: CSSValue = `var`("--chroma-teal")
public let chromaCyan: CSSValue = `var`("--chroma-cyan")
public let chromaBlue: CSSValue = `var`("--chroma-blue")
public let chromaIndigo: CSSValue = `var`("--chroma-indigo")
public let chromaPurple: CSSValue = `var`("--chroma-purple")
public let chromaPink: CSSValue = `var`("--chroma-pink")
public let chromaBrown: CSSValue = `var`("--chroma-brown")
public let chromaGray: CSSValue = `var`("--chroma-gray")
...
public let hueRed: CSSValue = `var`("--hue-red")
public let hueOrange: CSSValue = `var`("--hue-orange")
public let hueYellow: CSSValue = `var`("--hue-yellow")
public let hueGreen: CSSValue = `var`("--hue-green")
public let hueMint: CSSValue = `var`("--hue-mint")
public let hueTeal: CSSValue = `var`("--hue-teal")
public let hueCyan: CSSValue = `var`("--hue-cyan")
public let hueBlue: CSSValue = `var`("--hue-blue")
public let hueIndigo: CSSValue = `var`("--hue-indigo")
public let huePurple: CSSValue = `var`("--hue-purple")
public let huePink: CSSValue = `var`("--hue-pink")
public let hueBrown: CSSValue = `var`("--hue-brown")
public let hueGray: CSSValue = `var`("--hue-gray")
...
public let trafficLightRed: CSSColor = `var`("--traffic-light-red")
public let trafficLightYellow: CSSColor = `var`("--traffic-light-yellow")
public let trafficLightGreen: CSSColor = `var`("--traffic-light-green")
...
public let fillL: CSSValue = `var`("--fill-l")
public let fillLOffset: CSSValue = `var`("--fill-l-offset")
public let fillLHover: CSSValue = `var`("--fill-l-hover")
public let fillLActive: CSSValue = `var`("--fill-l-active")
public let fillCScale: CSSValue = `var`("--fill-c-scale")
public let fillCMult: CSSValue = `var`("--fill-c-mult")
public let glyphLHoverOffset: CSSValue = `var`("--glyph-l-hover-offset")
public let glyphLActiveOffset: CSSValue = `var`("--glyph-l-active-offset")
...
public let borderColorInputBinaryCheckedHover: CSSColor = `var`("--border-color-input-binary-checked-hover")
public let borderColorInputBinaryCheckedActive: CSSColor = `var`("--border-color-input-binary-checked-active")
...
public let syntaxAttributes: CSSColor = `var`("--color-syntax-attributes")
public let syntaxCharacters: CSSColor = `var`("--color-syntax-characters")
...
public let syntaxMarks: CSSColor = `var`("--color-syntax-marks")
public let syntaxNumbers: CSSColor = `var`("--color-syntax-numbers")
...
public let syntaxUrls: CSSColor = `var`("--color-syntax-urls")
