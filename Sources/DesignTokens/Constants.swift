...
public let fillL: Percentage = `var`("--fill-l")
public let fillLOffset: Percentage = `var`("--fill-l-offset")
public let fillLHover: Percentage = `var`("--fill-l-hover")
public let fillLActive: Percentage = `var`("--fill-l-active")
